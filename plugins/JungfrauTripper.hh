#ifndef JungfrauTripper_hh
#define JungfrauTripper_hh
...
namespace Pds {
  namespace Jungfrau { class ElementV2; };
  namespace Jungfrau { class ConfigV3; };
...
namespace Ami {
  ...
  //
  class JungfrauTripper : public UserModule {
  public:
    JungfrauTripper(const char* name="JungfrauTrip",
                    const char* short_name="JungfrauTrip");
    virtual ~JungfrauTripper();
  ...
  private:
    ...
    Pds::Jungfrau::ConfigV3* _config[MaxDetsAllowed];
    ...
    const Pds::Jungfrau::ElementV2* _frame[MaxDetsAllowed];
