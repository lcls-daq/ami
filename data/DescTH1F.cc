...
DescTH1F::DescTH1F(const char* name, 
		   ...
		   bool normalize,
                   bool aggregate) :
  DescEntry(name, xtitle, ytitle, TH1F, sizeof(DescTH1F), Mean, normalize, aggregate),
...
DescTH1F::DescTH1F(InitOpt,
		   ...
		   float xup,
		   bool normalize) :
  DescEntry(name, xtitle, ytitle, TH1F, sizeof(DescTH1F), Mean, normalize),
  _nbins(nbins ? nbins : 1),
  _unused(0),
  _reserved(0)
{
...
DescTH1F::DescTH1F(const Pds::DetInfo& info,
		   ...
		   float xup,
		   bool normalize) :
  DescEntry(info, channel, name, xtitle, ytitle, TH1F, sizeof(DescTH1F), Mean, normalize),
  _nbins(nbins ? nbins : 1),
  _unused(0),
  _reserved(0),
  _xlow(xlow),
