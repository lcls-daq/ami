...
OLD_FileSelect::OLD_FileSelect(QWidget* parent,
...
OLD_FileSelect::~OLD_FileSelect()
{
}

QStringList OLD_FileSelect::paths() const
{
  QStringList v;
  if (!_run.isEmpty()) {
...
void OLD_FileSelect::change_path_list(const QStringList& paths)
{
  _paths = paths;
...
void OLD_FileSelect::select_run(int row)
{
  if (row>=0) {
