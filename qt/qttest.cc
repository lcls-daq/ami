...
int main(int argc, char **argv) 
{
  ...
  add(cache, "BLD:EBEAM:ENERGYBC2");
  add(cache, "BLD:EBEAM:PKCURRBC1");
  add(cache, "BLD:EBEAM:ENERGYBC1");	
  add(cache, "BLD:EBEAM:UNDX");
  add(cache, "BLD:EBEAM:UNDY");	
  add(cache, "BLD:EBEAM:UNDXP");		
  add(cache, "BLD:EBEAM:UNDYP");
  add(cache, "BLD:EBEAM:XTCAVAMPL");
  add(cache, "BLD:EBEAM:XTCAVPHASE");	
  add(cache, "BLD:EBEAM:QDUMP");		
  add(cache, "BLD:EBEAM:PHOTENERGY");	
  add(cache, "BLD:EBEAM:LTU250");
  add(cache, "BLD:EBEAM:LTU450");	
